...
return [
     ...
     */
    'title' => "AT-WORK Documentation",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Добро пожаловать в документацию по API atwork, это в первую очередь поможет лучше понять функции, которыми обладает наш веб-сервис.',
